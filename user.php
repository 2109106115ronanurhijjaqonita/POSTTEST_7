...
<body>
    ...
    <footer id="about-me">
        <div class="footer container">
            ...
            <div class="img"></div>
            <div class="text">Rona Nurhijja <span> Qonita</span></div</div>
        <p class="desc"> Hallo!, nama saya Rona yang merupakan CEO website ini, silahkan dukung website ini dengan cara menon-aktifkan AdBlock browser kalian. Enjoy the music!.</p>
        </div>
        <div class="sosmed-footer" align="center">
            <div><a target="blank" href="https://www.instagram.com/qonitaatta_/" class="nav-link">
